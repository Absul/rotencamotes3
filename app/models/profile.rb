class Profile < ActiveRecord::Base
  ...
  def favorite_director_name
    self.favorite_director.nil? ? 'No especificado' : self.favorite_director #.short_name
  end

  def favorite_writer_name
    self.favorite_writer.nil? ? 'No especificado' : self.favorite_writer #.short_name
  end

  def favorite_actor_name
    self.favorite_actor.nil? ? 'No especificado' : self.favorite_actor #.short_name
  end

  def friendly_favorite_genre
    self.favorite_genre.nil? ? 'No especificado' : self.favorite_genre.name
  end
...
#  favorite_actor           :string(255)
#  favorite_director        :string(255)
#  favorite_writer          :string(255)
#  favorite_movie           :string(255)
#
